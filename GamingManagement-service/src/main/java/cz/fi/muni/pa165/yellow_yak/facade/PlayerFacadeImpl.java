...
public class PlayerFacadeImpl implements PlayerFacade {
    ...
    public List<PlayerDTO> listByUsername(String username) {
        ...
        return beanMappingService.mapTo(playerService.listByUsername(username), PlayerDTO.class);
    }

    @Override
    public List<PlayerDTO> listByTeam(Long teamId) {
        log.info("listing player by team, teamId = {}", teamId);
        return beanMappingService.mapTo(playerService.listByTeam(teamId), PlayerDTO.class);
    }
